...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine(){
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("kjh", "pw", null, null, null));
    ...
    void givenTestData_whenDeleting_thenWorksFine(){
        ...
        assertThat(articleRepository.count()).isEqualTo(previousArticleComment - deletedCommentsSize);
    }
}
